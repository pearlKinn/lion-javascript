...
function createSipnner(size = 100, loadingMessage = '😺유저 정보를 가져오는 중이다 냥!😺') {
  return /* html */ `
...
function createEmptyCard(size = 200, errorMessage = '😿알 수 없는 오류가 발생했다 냥😿') {
  return /* html */ `
...
export function renderSpinner(target) {
  insertLast(target, createSipnner())
}
